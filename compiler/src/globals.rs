...
pub struct Globals<'a> {
    ...
    pub types: AHashMap<HashId, Type>,
    pub type_ids: AHashMap<String, (HashId, CodeArea)>,
	
	pub type_instances: AHashMap<String, (Instance, CodeArea)>,
...
//         );
        ...
        let mut globals = Globals {
            ...
            types: AHashMap::default(),
            type_ids: AHashMap::default(),
			type_instances: AHashMap::default(),
